...
function instructions() {
    ...
    return [
        ...
        '10. Never position anything by hand: `arrange` lays groups out as blocks.',
        '11. Finish with `signature` once, `arrange`, then `review` - fix every finding marked blocking,',
    ...
    switch (method) {
        case 'initialize':
            reply(id, {
                ...
                capabilities: { tools: {} },
                serverInfo: { name: 'grasshopper', version: '0.22.0' },
